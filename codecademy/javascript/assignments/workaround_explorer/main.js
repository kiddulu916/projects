const salaryData = require('./modules/salaryData.js').salaryData;
const getCompanies = require('./modules/salaryData.js').getCompanies;
const getRoles = require('./modules/salaryData.js').getRoles; 
const getAverageSalaryByRole = require('./modules/workAroundModule.js').getAverageSalaryByRole;
const getAverageSalaryByCompany = require('./modules/workAroundModule.js').getAverageSalaryByCompany;
const getSalaryAtCompany = require('./modules/workAroundModule.js').getSalaryAtCompany;
const getIndustryAverageSalary = require('./modules/workAroundModule.js').getIndustryAverageSalary;
const fs = require('fs');
